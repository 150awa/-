...
LBL.BorderColor3 = Color3.new(220, 220, 220)
LBL.Position = UDim2.new(0.75,0,0.010,0)
LBL.Size = UDim2.new(0, 133, 0, 30)
LBL.Font = Enum.Font.GothamSemibold
LBL.Text = "Test"
LBL.TextColor3 = Color3.new(220, 220, 220)
LBL.TextScaled = true
LBL.TextSize = 14
...
Tab:AddButton({
  Name = "[+] 观察玩家",
  Callback = function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Player-viewer-18544"))()
  end
})"
...
Tab:AddButton({
  Name = "[+] 带来所有玩家",
  Callback = function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-TELEPORT-every-player-to-u-SCRIPT-BETA-18559"))()
  end
})
